...
-- Tiempo de generación: 25-11-2020 a las 16:43:11
...
--
-- Estructura de tabla para la tabla `mis_propiedades`
--

CREATE TABLE `mis_propiedades` (
  `id` int(255) NOT NULL,
  `id_propiedad` int(255) DEFAULT NULL
...
CREATE TABLE `propiedades` (
  ...
  `Codigo_Postal` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
...
INSERT INTO `propiedades` (`id`, `Direccion`, `Ciudad`, `Telefono`, `Codigo_Postal`, `Tipo`, `Precio`) VALUES
...
--
-- Indices de la tabla `mis_propiedades`
--
ALTER TABLE `mis_propiedades`
...
--
-- AUTO_INCREMENT de la tabla `mis_propiedades`
--
ALTER TABLE `mis_propiedades`
